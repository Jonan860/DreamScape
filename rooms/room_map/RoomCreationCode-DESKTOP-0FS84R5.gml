...
global.hud=instance_create_layer(x,y,"hud",obj_battle_hud)
...
var dread=scr_instance_create_at_tile_with_owner(obj_lich,100007,global.enemy)
dread.lvl=3
dread.spell_q_lvl=2
dread.spell_e_lvl=1
scr_instance_create_at_tile_with_owner(obj_crypt_fiend,100006,global.enemy)
with(obj_tile)
{
	if(tile_x=18 and tile_y=2)
	{
other.hungry_hungry_lizard=scr_instance_create_at_tile_with_owner(obj_hungry_hungry_lizard,self,global.creep_lord)
	break;
	}
}
...
//scr_instance_create_at_tile_with_owner(obj_ghoul,100102,global.player)
/*
...
footman1=instance_create_depth(4*16+12*16*5,4*16+8*16*5,-1,obj_golden_dragon)
