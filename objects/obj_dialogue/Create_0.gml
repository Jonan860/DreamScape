...
dialogue_audience3 = [global.lille_skutt_dialogue]
...
dialogue_audience4 = [global.ida_dialogue]

 
dialogue_speaker5 = global.ida_dialogue
dialogue_string5 = "En dröm! Ja det är en dröm!"
dialogue_audience5 = [global.lille_skutt_dialogue]
 
list_of_dialogue_strings = [dialogue_string1, dialogue_string2, dialogue_string3, dialogue_string4, dialogue_string5]
list_of_dialogue_speaker = [dialogue_speaker1, dialogue_speaker2, dialogue_speaker3, dialogue_speaker4, dialogue_speaker5]
list_of_list_of_audience = [dialogue_audience1, dialogue_audience2, dialogue_audience3, dialogue_audience4, dialogue_audience5]

list_of_dialogue_numbers_where_dialogue_change_to_battle_phase = [4]