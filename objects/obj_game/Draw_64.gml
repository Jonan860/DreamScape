...
{
draw_healthbar( camera_get_view_width(view_camera[0])-camera_get_view_width(view_camera[0])/4,camera_get_view_height(view_camera[0])/16,camera_get_view_width(view_camera[0])-camera_get_view_width(view_camera[0])/16,camera_get_view_height(view_camera[0])/16+camera_get_view_height(view_camera[0])/32,global.nils.HP/global.nils.max_HP*100,c_black,c_red,c_green,0,0,0)
}
...
for(i=0;i<=var_number_of_audiences-1;i+=1)
{
