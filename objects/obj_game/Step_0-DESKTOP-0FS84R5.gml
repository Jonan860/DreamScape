...
with(obj_unit_producing_building)
{
	...
	var var_build_time=ds_map_find_value(global.map_objects_to_build_time,self.object_index)
if(unfinished and global.lille_skutt.is_building=self)
{
...
{
human_barracks_build_progress+=100/5/game_get_speed(gamespeed_fps)
