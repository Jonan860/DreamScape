...
build = function(skill) {
	if(array_contains([obj_footman_defend_upgrade, obj_priest_dispel_upgrade, obj_sorceress_invisibility_upgrade, obj_sorceress_polymorph_upgrade, obj_improved_bows_upgrade], skill.animator)) {
		skill.perform()
