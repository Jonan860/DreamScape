...
with(var_selected_unit)
	...
	draw_sprite_ext(spr_w_button,0,other.hud_w_button_x,other.hud_w_button_y,other.spell_button_width/sprite_get_width(spr_w_button),other.spell_button_height/sprite_get_height(spr_w_button),0,-1,1)
		...
		if(var_selected_unit.object_index=obj_sorceress)
		{
		draw_sprite_ext(spr_q_button,floor(slow_icon_animation_index),other.hud_q_button_x,other.hud_q_button_y,other.spell_button_width/sprite_get_width(spr_q_button),other.spell_button_height/sprite_get_height(spr_q_button),0,-1,1)
		}
		else
		if(var_selected_unit.object_index=obj_banshee)
		{
		draw_sprite_ext(spr_q_button,floor(curse_icon_animation_index),other.hud_q_button_x,other.hud_q_button_y,other.spell_button_width/sprite_get_width(spr_q_button),other.spell_button_height/sprite_get_height(spr_q_button),0,-1,1)
		}
		else
		if(var_selected_unit.object_index=obj_priest)
		{
		draw_sprite_ext(spr_q_button,floor(heal_icon_animation_index),other.hud_q_button_x,other.hud_q_button_y,other.spell_button_width/sprite_get_width(spr_q_button),other.spell_button_height/sprite_get_height(spr_q_button),0,-1,1)
		}
		else
		{
...
/*
	...
	draw_sprite_ext(spr_q_button,0,other.hud_q_button_x,other.hud_q_button_y,other.spell_button_width/sprite_get_width(spr_q_button),other.spell_button_height/sprite_get_height(spr_q_button),0,-1,1)
			...
			if(object_index=obj_sorceress and global.player.sorceress_has_invisibility)
			{
				...
				{
					draw_set_color(c_green)
					draw_rectangle(camera_get_view_width(view_camera[0])-32-2*string_width(w_info),camera_get_view_height(view_camera[0])-global.hud.hud_height-32-2*string_height(w_info),camera_get_view_width(view_camera[0]),camera_get_view_height(view_camera[0])-global.hud.hud_height,0)
				draw_set_color(c_black)
