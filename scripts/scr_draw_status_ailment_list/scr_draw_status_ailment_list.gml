...
function scr_draw_status_ailment_list() {
	...
	for(var i = 0; i < ds_list_size(list_of_active_debuff_structs); i += 1) {
		...
		draw_sprite_ext(struct_debuff.icon, 0, var_hud.hud_buff_x + var_draw_x_translate * var_hud.hud_buff_width, var_hud.hud_buff_y, var_hud.hud_buff_width / sprite_get_width(struct_debuff.icon_sprite), var_hud.hud_buff_height / sprite_get_height(struct_debuff.icon_sprite), 0, c_white, 1)
		var_draw_position += 1
