/// @description scr_draw_status_ailment_list() called from selected unit in hud
function scr_draw_status_ailment_list() {
	var i=0
	var var_draw_position=0
	var var_draw_x_translate=0
	var var_hud=global.hud
	for(i=0;i<ds_list_size(list_of_active_debuff_structs);i+=1)
	{
var struct_debuff=ds_list_find_value(list_of_active_debuff_structs,i)
draw_sprite_ext(struct_debuff.icon_sprite,0,var_hud.hud_buff_x+var_draw_x_translate*var_hud.hud_buff_width,var_hud.hud_buff_y,var_hud.hud_buff_width/sprite_get_width(struct_debuff.icon_sprite),var_hud.hud_buff_height/sprite_get_height(struct_debuff.icon_sprite),0,c_white,1)
	var_draw_position+=1
