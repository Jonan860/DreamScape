...
for(i=path_length-1;i>0;i-=1)
{
var tile_to_clear=ds_list_find_value(invis_path,i-1)
var tile_to_fill=ds_list_find_value(invis_path,i)
var var_unit_to_move_list=ds_map_find_value(tile_to_clear.occupants,var_altitude)
var var_unit_to_move=ds_list_find_value(var_unit_to_move_list,0)
