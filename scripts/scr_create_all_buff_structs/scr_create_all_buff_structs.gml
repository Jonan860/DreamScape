...
spell_health : 100,
info : "Slows targets movement and attack speed by "+string(speed_reduction*100)+"." + "%"+"\n Duration:"
+string(duration) + " seconds."+" Range:"+string(range)
...
cooldown : 1,
mana_cost : 15,
info : "Makes a friendly target invisible for "+string(duration)+" seconds,",
info_abilities : info+"and increases mana of sorceresses by"+string(mana)+"and mana regen",
}
...
+"\n Mana cost: "+string(ds_list_find_value(global.freeze_struct.mana_cost_list,i))+" Duration: "+string(ds_list_find_value(global.freeze_struct.duration_list,i))+" Range: "+string(global.freeze_struct.range)
