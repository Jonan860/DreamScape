function scr_level_up_q_spell() {
	...
	if(var_selected == global.nils) {
		global.nils.spell_q_heal_amount = global.nils.list_spell_q_heal_amount[|spell_q_lvl - 1]
		global.nils.spell_q_mana_cost = global.nils.list_spell_q_cost[|spell_q_lvl - 1]
	...
	if(var_selected == global.ida) {
		var freeze_time = global.freeze_struct.duration_list[|spell_q_lvl - 1]
		var freeze_mana_cost = global.ida.spell_q_struct.mana_cost_list[|spell_q_lvl - 1]
