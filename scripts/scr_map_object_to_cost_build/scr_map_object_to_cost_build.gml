function scr_map_object_to_cost_build() {
	ds_map_add(global.map_object_to_costs, obj_human_barrack,  100)
	ds_map_add(global.map_object_to_costs, obj_arcane_sanctum, 100)
	ds_map_add(global.map_object_to_costs, obj_sorceress, 100)
	...
	ds_map_add(global.map_object_to_costs, obj_priest_dispel_upgrade, 150)
	ds_map_add(global.map_object_to_costs, obj_improved_bows_upgrade, 150)
}
