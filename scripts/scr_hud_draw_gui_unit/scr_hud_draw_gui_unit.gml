	...
	if(object_is_ancestor(object_index, obj_unit)) {
		...
		with(global.hud) {
			...
			if(other.altitude == "invisible") {
				...
				global.hud.hud_height / sprite_get_height(other.sprite_index), 0, -1, 0.5)
			} else {
				draw_sprite_ext(other.sprite_index, 0, global.hud.hud_width/6, camera_get_view_height(view_camera[0]) - global.hud.hud_height/2, global.hud.hud_width/4 / sprite_get_width(other.sprite_index),
				global.hud.hud_height / sprite_get_height(other.sprite_index), 0, -1, 1)
			}
